...
;~ 	_GUICtrlComboBox_SetCurSel($cmbAttackTHType, $icmbAttackTHType)
	...
	; If $ichkCloseTraining = 1 Then
		; GUICtrlSetState($chkRemainTrain, $GUI_CHECKED)
	; Else
		; GUICtrlSetState($chkRemainTrain, $GUI_UNCHECKED)
	; EndIf
	; If $ichkCloseNight = 1 Then
		; GUICtrlSetState($chkRemainNight, $GUI_CHECKED)
	; Else
		; GUICtrlSetState($chkRemainNight, $GUI_UNCHECKED)
	; EndIf
